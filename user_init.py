...
# Init block ==================================================
    def __init__(self, login, uid, userfio, email, phonenumber, layer_id, locale, is_superadmin, is_localadmin):
        self.login = login
        self.uid = uid
        ...
        self.is_localadmin = bool(is_localadmin)
...
def create_user_session_class(login, uid, userfio, email, phonenumber, layer_id, locale, is_superadmin, is_localadmin):
    ...
    cpu.setSesVar('user_init_class', UserInit(login=login, uid=uid, userfio=userfio, email=email,
                                              ...
                                              is_superadmin=is_superadmin, is_localadmin=is_localadmin))
...
def get_user_systems(uid, higher=None, recurse=1, systems_order=None, spaces_per_level=24, use_layers=None, conEngine=None):
    """Дерево замапленных систем пользователя.
