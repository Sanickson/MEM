  ...
  function formatDate(dt)
  {
    ...
    var dvHTML ='<div id=dvShop class=leftrel>\
                    <div id=dvShopObj class=leftrel style="border-bottom:1px solid;text-align:center">\
                        <b>Объект: </b><select id='+idSelObj+' name="whid"></select>\
                    </div>\
                ...
                <div id=dvTask class=leftrel>\
                    <div id=dvTaskTop class=leftrel style="border-bottom:1px solid;text-align:center">\
                        <form id=frmFilterTask class="leftrel buttons" style="text-align:center;vertical-align:middle;">\
                            <b>Период: </b>\
                            ...
                            <b>ГО: </b><select id="sgid"  name=sgid ></select>&nbsp;\
                            <button type=submit title=Поиск><img src='+eng_img+'/actions/magnifier.png border=0></button>\
                            &nbsp;&nbsp;&nbsp;<br><br>\
                        </form>\
                        <div id=dvButtons class="leftrel buttons" style="text-align:right;">\
    ...
    $.fn.SelectManager = function(){
        ...
        var w1 = $("#frmFilterTask").width();
        var w2 = $("#dvButtons").width();
        var wAll = $('#dvTaskTop').width();
        $("#frmFilterTask").css({width: kInt(w1*99/(w1+w2))+'%'});
        $("#dvButtons").css({width: kInt(w2*99/(w1+w2))+'%'});
