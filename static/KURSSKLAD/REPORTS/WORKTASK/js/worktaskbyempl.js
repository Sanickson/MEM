      ...
      if ($.globalTimer) {
        ...
        $('#tblTaskByEmpl')
          ...
          .find('tbody>tr>td').dblclick(function () {
            ...
            /*var $taskManagerView = $('#dvTaskes').taskManagerView({
              useviewunit: true
            });

            $taskManagerView.listTask({
              urlTask: 'listTask',
              dbeg: timebeg.split(' ')[0],
              tbeg: timebeg.split(' ')[1],
              dend: timeend.split(' ')[0],
              tend: timeend.split(' ')[1],
              men: ID($(this).parents('tr:first').attr('id')),
              status: '2'
              //tasktype: ttid_l
            });*/
