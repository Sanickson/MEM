...
function canSelect(element){
  return (!element.disabled &&
          ...
          !(element.nodeName=='INPUT' && element.readOnly) &&
...
function handleMarkerKeyDown(evt){
  ...
  if (getKeyCode(evt) == 40) { //KEY DOWN
    markerMoveDown(evt);
  }
  if (getKeyCode(evt) == 38) { //KEY UP
    markerMoveUp(evt);
  }
