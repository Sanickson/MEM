...
engine_version = '1.31'
engine_date_version = '10.09.2014'
accepted_db_version = '1.27'
...
def get_full_version():
    return engine_version + ' - ' + accepted_db_version + pu.convToConsole(u' от ') + engine_date_version

def get_firepy_version():
    return engine_version, accepted_db_version, engine_date_version
