...
class Customers(imp_object.Obj):
        ...
        if obj is not None:
            ...
            if parent_class.xml_name_external_id:
                ...
                if not self.parent_id:
                    self.parent_id = self.xml_get_value(obj, 'parent' + parent_class.xml_name_external_id, flag='N')
    ...
    def save_bank_account(self):
        ...
        accounts = self.__obj.find(self.parent_class.name_space + 'accounts')
    ...
    def save_print_data(self):
        ...
        print_data = self.__obj.find(self.parent_class.name_space + 'printdata')
    ...
    def save_activity(self):
        ...
        activities = self.__obj.find(self.parent_class.name_space + 'cactivities')
