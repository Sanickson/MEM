...
from systems.KURSSKLAD.REPORTS.WORKTASKBONUS.templates.worktaskrate import worktaskrate
from systems.KURSSKLAD.REPORTS.WORKTASKBONUS.templates.worktaskratebyempl import worktaskratebyempl
