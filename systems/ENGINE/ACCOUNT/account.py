...
class Account(SysLogin):
    ...
    def __init__(self):
        ...
        if si.password_recovery_enabled:
            self.recovery.__func__.exposed = True
            self.verifyuser.__func__.exposed = True
            self.rp.__func__.exposed = True
            self.rp_drop.__func__.exposed = True
        self.get_pwd_complexity_status.__func__.exposed=True
        if si.regopen:
            self.index.__func__.exposed = True
            self.createaccount.__func__.exposed = True
