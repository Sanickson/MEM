...
class FieldStorage(cgi.FieldStorage):
    ...
    def make_file(self, binary=None):
        ...
        if cherrypy.request.remote.ip in cherrypy.file_transfers:
...
class Updater(BasePage): #, TCommon):
    ...
    def upload_stats(self):
        try:
            ...
            #print "======"
            if cherrypy.request.remote.ip not in cherrypy.file_transfers:
    ...
    def upload(self):
        ...
        try:
            ...
            ld=os.listdir(cat)
            #print "ld: ", ld
            ld_7z=[fn for fn in ld if os.path.splitext(fn)[1]=='.7z' and len(fn.split('='))>1 and fn.split('=')[1].isdigit()]
            ld_7z.sort()
            #ld_7z.reverse()
            #print "ld_7z: ", ld_7z
    ...
    def getCommonReportWhatsNew(self,datein, in_txt=None):
        ...
        if(in_txt is None):
            ...
            for item in res['datalist']:
                ...
                if(item['SYSTEM_NAME'] not in systems):
